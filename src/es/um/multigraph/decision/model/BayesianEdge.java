...
public class BayesianEdge extends Edge{
    ...
    /**
     * Given the vulnerability exposure information (CVSS attribute) the
     * probability of success while executing a given vulnerability exploitation
     * is computed from CVSS Exploitability sub-score as: 2 * B_AV * B_AC * B_AU
     *
     * @see CVSSBase
